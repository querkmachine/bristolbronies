<?php
  ...
  */
  ...
  $font['date'] = "wp-content/themes/ashman/assets/type/Lato-Regular.ttf";
  $font['title'] = "wp-content/themes/ashman/assets/type/Lato-Black.ttf";
  $size['date'] = 10;
  $size['title'] = 22;
  imagefill($image, 0, 0, $color['background']);
  $logo = imagecreatefromstring(file_get_contents("wp-content/themes/ashman/assets/img/logo-signature.png"));
