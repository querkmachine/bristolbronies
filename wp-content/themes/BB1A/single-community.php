  ...
  <main class="container" id="main" role="main">
      ...
      <article class="post">
        ...
        <aside class="post-card post-event-details">
          ...
          <div class="post-card-map" style="background-image: url('http://maps.googleapis.com/maps/api/staticmap?zoom=14&amp;size=480x160&amp;scale=2&amp;maptype=roadmap&amp;markers=color:red%7Clabel:S%7C<?php echo $camera['latitude']['deg']; ?>,<?php echo $camera['longitude']['deg']; ?>&amp;sensor=false');">
          </div>
          <?php } ?>
