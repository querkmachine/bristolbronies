...
<div id="em-booking" class="em-booking <?php if( get_option('dbem_css_rsvp') ) echo 'css-booking'; ?>">
	...
	<?php else: ?>
		...
		<?php if( $tickets_count > 0) : ?>
			...
			<form class="em-booking-form" name='booking-form' method='post' action='<?php echo apply_filters('em_booking_form_action_url',''); ?>'>
				...
				<?php if( $can_book ): ?>
			      ...
			      <p>This event is space limited. Be sure to reserve your place by filling out the form below. Those with reservations will be given priority over those who don't.</p>
						<?php 
